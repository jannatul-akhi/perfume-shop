...
const Recommended = () => {
  return (
    <MainPageLayout>
      <div>
        <h1 className="text-3xl font-750 text-black text-center mt-16 mb-8">
          Recommended for you
        </h1>
